...
def process_case(case_id: int, batch_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    with Session(engine) as session:
        ...
        # Step 3: Execution / Action Simulator
        sim_result = None
        ...
        sse_event = {
            ...
            "approved": (guardrail_result.get("decision") == "APPROVED"),
            "amount_recovered": float(sim_result.get("recovered_amount", 0.0)) if sim_result else 0.0,
